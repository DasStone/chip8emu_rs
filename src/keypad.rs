...
impl Keypad {
    ...
    pub fn poll(&mut self) -> InputEvent {
        ...
        for key in keys {
            match key {
                Keycode::Num1 => keypad_state[0x1] = 1,
                Keycode::Num2 => keypad_state[0x2] = 1,
                Keycode::Num3 => keypad_state[0x3] = 1,
                Keycode::Num4 => keypad_state[0xC] = 1,
                Keycode::Q => keypad_state[0x4] = 1,
                Keycode::W => keypad_state[0x5] = 1,
                Keycode::E => keypad_state[0x6] = 1,
                Keycode::R => keypad_state[0xD] = 1,
                Keycode::A => keypad_state[0x7] = 1,
                Keycode::S => keypad_state[0x8] = 1,
                Keycode::D => keypad_state[0x9] = 1,
                Keycode::F => keypad_state[0xE] = 1,
                Keycode::Z => keypad_state[0xA] = 1,
                Keycode::X => keypad_state[0x0] = 1,
                Keycode::C => keypad_state[0xB] = 1,
